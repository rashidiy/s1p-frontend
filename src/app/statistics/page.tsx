...
export default function StatisticsPage() {
  ...
  const loadStatistics = async () => {
    ...
    setLoading(true);
    try {
      const stats = await apiClient.getCallStatistics({
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">1,542 (54%)</span>
                </div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium">1,105 (39%)</span>
                </div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium">200 (7%)</span>
                </div>
              </div>
            </CardContent>
          </Card>
